...
def print_help(arguments):
	if len(arguments) > 1:
		raise Exception('There were too many arguments supplied to the help function!')
...
if __name__ == "__main__":
	...
	# handle prefix and suffix
		...
		raise Exception('The arguments you supplied are not supported. See try python fix_search.py --help for help')
